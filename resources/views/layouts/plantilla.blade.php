...
<body>
  ...
  <header>
    ...
    <div class="area-logo">
      <a href="{{ route('Index') }}"><img src="{{ asset('img/varios/logo-cinestar.png') }}" /></a>
    </div>
    <nav class="menu">
      <span class="img-social">
        <a href="http://www.facebook.com/multicinestar" target="_blank"><img
            src="{{ asset('img/varios/ico-face.png') }}" /></a>
        <a href="http://www.twitter.com/multicinestar" target="_blank"><img
            src="{{ asset('img/varios/ico-twitter.png') }}" /></a>
      </span>
    ...
    <div class="papaya">
      <a href="http://www.cinepapaya.com/pe/cinestar" target="_blank"><img
          src="{{ asset('img/varios/bg-papaya.jpg') }}" /></a>
    </div>
  </header>
